                                ...
                                <form action="#" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9 contentImg">
                                            <div class="bigImgs">
                                                <img class="bigImg" src="assets/img/yangyang_3.png"
                                                    style="height: 300px;width: 100%;">
                                            </div>
                                            <div class="smallImgs">
                                                <img class="smallImg" style="height: 100px;width: 150px;"
                                                    src="assets/img/detail-1.PNG">
                                                <img class="smallImg" style="height: 100px;width: 150px;"
                                                    src="assets/img/detail-2.PNG">
                                                <img class="smallImg" style="height: 100px;width: 150px;"
                                                    src="assets/img/detail-3.PNG">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="cinfoName"
                                                placeholder="게시글 이름 입력" value="황제 서핑 서면으로 오세요" name="memId" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control col-sm-9" rows="3" id="textarea-copy"
                                                ...
                                                readonly>지금까지 이런 곳은 없었다</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="cinfoName"
                                                placeholder="위도가 자동으로 입력됩니다." value="" name="" readonly>
                                        </div>
                                    </div>
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" id="cinfoName"
                                                placeholder="경도가 자동으로 입력됩니다." value="" name="" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" placeholder="우편번호" value="12345"
                                                name="" readonly>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" placeholder="상세주소 입력" value="1단지"
                                                name="addressDetail">
                                        </div>
                                    </div>
                                ...
                                <form action="#" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea class="form-control col-sm-9" rows="3" id="textarea-copy"
                                                style="height: 189px;" name="cinfoContent" placeholder="게시글 유의사항 입력"
                                                readonly>리얼 맛집이다다다ㅏ다ㅏ니다.</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" class="form-control" placeholder="상세주소 입력" value="산간지역 주차장"
                                                name="addressDetail">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" name="checkbox" checked> 금요일
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" name="checkbox" checked> 토요일
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" name="checkbox" checked> 일요일
                                                </label>
                                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" name="checkbox" checked> 바다
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label>
                                            ...
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" name="checkbox" checked> 주차장
                                                </label>
                                            </div>
                                            <div class="checkbox">
                                                <label>
                                                    <input type="checkbox" name="checkbox" checked> 캠핑장
                                                </label>
                                            </div>
                                        </div>
                                    </div>
