...
<link rel="shortcut icon" href="resources/admin/assets/img/favicon.png"
	type="text/css">
<link rel="stylesheet"
	href="resources/admin/assets/css/bootstrap.min.css" type="text/css">
<link rel="stylesheet"
	href="resources/admin/assets/plugins/fontawesome/css/fontawesome.min.css"
	type="text/css">
<link rel="stylesheet"
	href="resources/admin/assets/plugins/fontawesome/css/all.min.css"
	type="text/css">
...
<body
	...
	<div class="main-wrapper">
		...
		<div class="header header-one">
			<div class="header-left header-left-one">
				<a href="index.html" class="logo"> <img
					...
					src="resources/admin/assets/img/Logo.png" alt="Logo" width="30"
					height="30">
				</a>
			</div>
			...
			<ul class="nav nav-tabs user-menu">
				...
				<li class="nav-item dropdown has-arrow main-drop"><a href="#"
					class="dropdown-toggle nav-link" data-bs-toggle="dropdown"> <span
						class="user-img"> <img
							src="resources/admin/assets/img/userImg.png" alt=""> <span
		...
		<script
			src="resources/admin/assets/plugins/slimscroll/jquery.slimscroll.min.js"></script>
		<script
			src="resources/admin/assets/plugins/apexchart/apexcharts.min.js"></script>
