				...
				<div class="row">
					<div class="col-sm-6 col-sm-offset-1">
						...
						<div align="center" id="mainImg">
							...
							<small style='color: blue;'>수정하고 싶다면 이미지를 클릭해주세요<br></small>
...
$(function(){
	...
	// 주소로 좌표를 검색합니다
	geocoder.addressSearch('${cinfo.cinfoAddress}', function(result, status) {

	    // 정상적으로 검색이 완료됐으면 
	     if (status === kakao.maps.services.Status.OK) {

	        var coords = new kakao.maps.LatLng(${cinfo.cinfoLttd}, ${cinfo.cinfoHrdns});
	        ...
	        var infowindow = new kakao.maps.InfoWindow({
	            content: '<button type="button" class="btn" id="google-search-button" onclick="googleSearch()">${cinfo.cinfoAddress}</button>'
	        });
