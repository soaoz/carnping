                            ...
                            <div class="clear">
                                <div class="col-sm-3 col-sm-offset-1">
                                    <div class="picture-container">
                                        <div class="picture" >
                                            <img src="img/mypage.png" class="picture-src" id="wizardPicturePreview" title="" style="max-width: 100%;"/>
...
<jsp:include page="../common/footer.jsp"/>
        ...
        <script src="resources/member/assets/js/vendor/modernizr-2.6.2.min.js"></script>
