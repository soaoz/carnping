...
public class SmsService {
	...
	public int send_msg(String tel, String rand) {
        ...
        // 개인 인증키
        String accessKey = "1AooOSi4o8SpwUyRhCMy";
        // 2차 인증을 위해 서비스마다 할당되는 service secret
        String secretKey = "0aITT8AF7WpGkhgcoHyfjsZWICKaUY0xuQCDRyUA";
        ...
        // 난수와 함께 전송
        toJson.put("content","Carnping 인증번호 ["+rand+"]");		
        toJson.put("to","01076250340");
        toArr.add(toJson);
